...
I am various things, but among those things, I am an associate professor at the `London Interdisciplinary School`_.  I teach data science.

By "data science", I don't mean "big data and machine learning", but the wider
conception of data science as a `new model of data analysis in the age of
ubiquitous computing
<https://lisds.github.io/textbook/intro/what-is-data-science.html>`_.  This is
data science as the foundation for data analysis.  It replaces standard
teaching of introductory statistics, but has a stronger emphasis on data
exploration and computing.  We want to teach the next generation of researchers
to be more flexible, accurate and effective in analyzing the kinds of data
generated by modern research.

This is `the current textbook for my courses on data science
<https://lisds.github.io/textbook>`_.  It took much inspiration, and some
